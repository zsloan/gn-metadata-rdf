...
def build_nodes(pheno_graph, this_pubxref, db_session):
    ...
    group_id, group_name, group_code = db_session.execute(f"SELECT InbredSet.Id, InbredSet.Name, InbredSet.InbredSetCode from InbredSet where InbredSet.Id ={ group_id };").fetchone()
